...
// constructor.
    OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::LaunchEnableForConcurrentThreadsAt_SERVER_Control()
    {
        ...
        stat_create_flag_praisinglaunch(newDEFAULT_Flagbit1);
        delete newDEFAULT_Flagbit1;
        uint32_t* newDEFAULT_uint32_t = new uint32_t(UINT32_MAX);
        stat_create_list_Of_launchActive_Count_For_ThreadID(newDEFAULT_uint32_t);
        stat_create_list_Of_launchIdle_Count_For_ThreadID(newDEFAULT_uint32_t);
        delete newDEFAULT_uint32_t;
        stat_create_list_for_Que_Of_CoreTolaunch();
        uint8_t* newDEFAULT_int8_t = new uint8_t(INT8_MAX);
        stat_create_concurrentCycle_Try_CoreId_Index(newDEFAULT_int8_t);
        stat_create_new_concurrentCycle_Try_CoreId_Index(newDEFAULT_int8_t);
...
// private.
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::launchEnable_ShiftQueValues(OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Framework* obj, uint8_t concurrentThreadID_A, uint8_t concurrentThreadID_B)
    {
        ...
        // set.
    // static.
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::stat_create_concurrentCycle_Try_CoreId_Index(uint8_t* newDEFAULT_Value)
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::stat_create_flag_praisinglaunch(bool* newDEFAULT_Flagbit)
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::stat_create_list_Of_launchActive_Count_For_ThreadID(uint32_t* newDEFAULT_Value)
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::stat_create_list_Of_launchIdle_Count_For_ThreadID(uint32_t* newDEFAULT_Value)
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::stat_create_list_Of_STATE_For_ConcurrentCore(bool* newDEFAULT_FlagBit)
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::stat_create_list_for_Que_Of_CoreTolaunch()
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::stat_create_new_concurrentCycle_Try_CoreId_Index(uint8_t* newDEFAULT_Value)
    {
