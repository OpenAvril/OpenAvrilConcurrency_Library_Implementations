...
// public.
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::initialise_new_concurrentCycle_Try_CoreId_Index(uint8_t* newINITIALISED_Value)
    {
        set_new_concurrentCycle_Try_CoreId_Index(*newINITIALISED_Value);
    }
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::initialise_list_for_Que_Of_CoreTolaunch()
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::launchEnable_Request(OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Framework* obj, uint8_t concurrent_CoreId)
    {
    ...
    std::list<uint32_t>* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::get_ptr_list_Of_launchActive_Count_For_ThreadID()
    {
        return _ptr_list_Of_launchActive_Count_For_ThreadID;
    }
    std::list<uint32_t>* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::get_ptr_list_Of_launchIdle_Count_For_ThreadID()
    {
        return _ptr_list_Of_launchIdle_Count_For_ThreadID;
    }
    std::list<bool>* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::get_ptr_list_Of_STATE_For_ConcurrentCore()
    {
        return _ptr_list_Of_STATE_For_ConcurrentCore;
    }
    std::list<uint8_t>* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::get_ptr_list_for_Que_Of_CoreTolaunch()
    {
...
// private.
    // dynamic.
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::dynamicStagger(OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Framework* obj, uint8_t concurrent_CoreId)
    {
        if (obj->get_ptr_LaunchConcurrency()->get_ptr_LaunchConcurrency_Control()->get_concurrentCycle_Try_CoreId_Index() == concurrent_CoreId)
        {
            //exit early
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::launchEnable_ShiftQueValues(OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Framework* obj, uint8_t concurrent_CoreId_A, uint8_t concurrent_CoreId_B)
    {
        int temp_Int;
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::create_ptr_list_Of_launchActive_Count_For_ThreadID()
    {
        set_ptr_list_Of_launchActive_Count_For_ThreadID(&_list_Of_launchActive_Count_For_ThreadID);
    }
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::create_ptr_list_Of_launchIdle_Count_For_ThreadID()
    {
        set_ptr_list_Of_launchIdle_Count_For_ThreadID(&_list_Of_launchIdle_Count_For_ThreadID);
    }
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::create_ptr_list_Of_STATE_For_ConcurrentCore()
    {
        set_ptr_list_Of_STATE_For_ConcurrentCore(&_list_Of_STATE_For_ConcurrentCore);
    }
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::create_ptr_list_for_Que_Of_CoreTolaunch()
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::set_ptr_list_Of_launchActive_Count_For_ThreadID(std::list<uint32_t>* newPtr)
    {
        _ptr_list_Of_launchActive_Count_For_ThreadID = newPtr;
    }
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::set_ptr_list_Of_launchIdle_Count_For_ThreadID(std::list<uint32_t>* newPtr)
    {
        _ptr_list_Of_launchIdle_Count_For_ThreadID = newPtr;
    }
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::set_ptr_list_Of_STATE_For_ConcurrentCore(std::list<bool>* newPtr)
    {
        _ptr_list_Of_STATE_For_ConcurrentCore = newPtr;
    }
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER::LaunchEnableForConcurrentThreadsAt_SERVER_Control::set_ptr_list_for_Que_Of_CoreTolaunch(std::list<uint8_t>* newPtr)
    {
