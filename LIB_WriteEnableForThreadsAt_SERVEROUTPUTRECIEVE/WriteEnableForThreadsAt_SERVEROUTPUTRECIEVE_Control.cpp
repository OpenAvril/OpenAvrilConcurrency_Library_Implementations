...
// public.
    ...
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::initialise_flag_praisingWrite(bool newDEAFULT_bool)
    {
        _flag_praisingWrite = newDEAFULT_bool;
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::initialise_Item_On_list_Of_2ibt_flag_WriteState(uint8_t slot, std::list<bool>* newINITIALISED_boolList)
    {
        auto temp = get_ptr_list_Of_2ibt_flag_WriteState()->begin();
        std::advance(temp, slot);
        *temp = *newINITIALISED_boolList;
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::initialise_Item_On_list_Of_WriteActive_Count_For_ThreadId(uint8_t concurrenctThreadID, uint32_t* newINITIALISED_uint32_t)
    {
    ...
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::initialise_Item_On_list_Of_WriteIdle_Count_For_ThreadId(uint8_t concurrenctThreadID, uint32_t* newINITIALISED_uint32_t)
    {
        auto temp = get_ptr_list_Of_WriteIdle_Count_For_ThreadId()->begin();
        std::advance(temp, concurrenctThreadID);
        *temp = *newINITIALISED_uint32_t;
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::initialise_Item_On_list_Of_WriteWait_Count_For_ThreadId(uint8_t concurrenctThreadID, uint32_t* newINITIALISED_uint32_t)
    {
    ...
    std::list<bool> OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::get_Item_On_list_Of_2ibt_flag_WriteState(uint8_t concurrenctThreadID)
    {
        auto temp = get_ptr_list_Of_2ibt_flag_WriteState()->begin();
        std::advance(temp, concurrenctThreadID);
        return *temp;
    }
    uint32_t OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::get_Item_On_list_Of_WriteActive_Count_For_ThreadId(uint8_t concurrenctThreadID)
    {
        auto temp = get_ptr_list_Of_WriteActive_Count_For_ThreadId()->begin();
        std::advance(temp, concurrenctThreadID);
        return *temp;
    }
    uint32_t OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::get_Item_On_list_Of_WriteIdle_Count_For_ThreadId(uint8_t concurrenctThreadID)
    {
        auto temp = get_ptr_list_Of_WriteIdle_Count_For_ThreadId()->begin();
        std::advance(temp, concurrenctThreadID);
        return *temp;
    }
    uint32_t OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::get_Item_On_list_Of_WriteWait_Count_For_ThreadId(uint8_t concurrenctThreadID)
    {
        auto temp = get_ptr_list_Of_WriteWait_Count_For_ThreadId()->begin();
        std::advance(temp, concurrenctThreadID);
        return *temp;
    ...
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::set_Item_On_list_Of_2ibt_flag_WriteState(uint8_t concurrenctThreadID, std::list<bool> newState)
    {
        auto temp = get_ptr_list_Of_2ibt_flag_WriteState()->begin();
        std::advance(temp, concurrenctThreadID);
        *temp = newState;
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::set_Item_On_list_Of_WriteActive_Count_For_ThreadId(uint8_t concurrenctThreadID, uint32_t newCount)
    {
        auto temp = get_ptr_list_Of_WriteActive_Count_For_ThreadId()->begin();
        std::advance(temp, concurrenctThreadID);
        *temp = newCount;
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::set_Item_On_list_Of_WriteIdle_Count_For_ThreadId(uint8_t concurrenctThreadID, uint32_t newCount)
    {
        auto temp = get_ptr_list_Of_WriteIdle_Count_For_ThreadId()->begin();
        std::advance(temp, concurrenctThreadID);
        *temp = newCount;
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::set_Item_On_list_Of_WriteWait_Count_For_ThreadId(uint8_t concurrenctThreadID, uint32_t newCount)
    {
        auto temp = get_ptr_list_Of_WriteWait_Count_For_ThreadId()->begin();
        std::advance(temp, concurrenctThreadID);
        *temp = newCount;
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::set_Item_On_QUE_List_Of_ThreadToWrite(uint8_t slotID, uint8_t concurrenctThreadID)
    {
        auto temp = get_ptr_QUE_List_Of_ThreadToWrite()->begin();
        std::advance(temp, concurrenctThreadID);
