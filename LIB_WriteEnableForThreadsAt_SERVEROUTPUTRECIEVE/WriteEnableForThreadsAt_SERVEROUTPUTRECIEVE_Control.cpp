...
// public.
    ...
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::initialise_flag_praisingWrite(OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj, bool newDEAFULT_bool)
    {
        obj->get_ptr_WriteEnable()->get_ptr_WriteEnable_Control()->set_flag_praisingWrite(newDEAFULT_bool);
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::initialise_Item_On_list_Of_2ibt_flag_WriteState(OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj, uint8_t slot, std::list<bool>* newINITIALISED_boolList)
    {
    ...
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::initialise_Item_On_list_Of_WriteActive_Count_For_ThreadId(OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj, uint8_t concurrenctThreadID, uint32_t* newINITIALISED_uint32_t)
    {
    ...
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::initialise_Item_On_list_Of_WriteIdle_Count_For_ThreadId(OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj, uint8_t concurrenctThreadID, uint32_t* newINITIALISED_uint32_t)
    {
    ...
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::initialise_Item_On_list_Of_WriteWait_Count_For_ThreadId(OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj, uint8_t concurrenctThreadID, uint32_t* newINITIALISED_uint32_t)
    {
    ...
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::initialise_new_writeCycle_Try_ThreadId_Index(OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj, uint8_t* newINITIALISED_uint8_t)
    {
        obj->get_ptr_WriteEnable()->get_ptr_WriteEnable_Control()->set_new_writeCycle_Try_ThreadId_Index(*newINITIALISED_uint8_t);
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::initialise_Item_On_QUE_List_Of_ThreadToWrite(OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj, uint8_t slotID, uint8_t* newINITIALISED_uint8_t)
    {
    ...
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::initialise_writeCycle_Try_ThreadId_Index(OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj, uint8_t* newINITIALISED_uint8_t)
    {
    ...
    std::list<bool> OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::get_Item_On_list_Of_2ibt_flag_WriteState(OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj, uint8_t concurrenctThreadID)
    {
    ...
    uint32_t OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::get_Item_On_list_Of_WriteActive_Count_For_ThreadId(OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj, uint8_t concurrenctThreadID)
    {
        auto temp = obj->get_ptr_WriteEnable()->get_ptr_WriteEnable_Control()->get_ptr_list_Of_WriteActive_Count_For_ThreadId()->begin();
        std::advance(temp, concurrenctThreadID);
        return *temp;
    }
    uint32_t OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::get_Item_On_list_Of_WriteIdle_Count_For_ThreadId(OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj, uint8_t concurrenctThreadID)
    {
        auto temp = obj->get_ptr_WriteEnable()->get_ptr_WriteEnable_Control()->get_ptr_list_Of_WriteIdle_Count_For_ThreadId()->begin();
        std::advance(temp, concurrenctThreadID);
        return *temp;
    }
    uint32_t OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::get_Item_On_list_Of_WriteWait_Count_For_ThreadId(OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj, uint8_t concurrenctThreadID)
    {
        auto temp = obj->get_ptr_WriteEnable()->get_ptr_WriteEnable_Control()->get_ptr_list_Of_WriteWait_Count_For_ThreadId()->begin();
        std::advance(temp, concurrenctThreadID);
        return *temp;
    }
    uint8_t OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::get_Item_On_QUE_List_Of_ThreadToWrite(OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj, uint8_t slotID)
    {
    ...
    std::list<uint32_t>* OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::get_ptr_list_Of_WriteActive_Count_For_ThreadId()
    {
        return _ptr_list_Of_WriteActive_Count_For_ThreadId;
    }
    std::list<uint32_t>* OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::get_ptr_list_Of_WriteIdle_Count_For_ThreadId()
    {
        return _ptr_list_Of_WriteIdle_Count_For_ThreadId;
    }
    std::list<uint32_t>* OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::get_ptr_list_Of_WriteWait_Count_For_ThreadId()
    {
        return _ptr_list_Of_WriteWait_Count_For_ThreadId;
    }
    std::list<std::list<bool>>* OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::get_ptr_list_Of_2ibt_flag_WriteState()
    {
        return _ptr_list_Of_2ibt_flag_WriteState;
    }
    std::list<uint8_t>* OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::get_ptr_QUE_List_Of_ThreadToWrite()
    {
    ...
    uint8_t OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::get_writeCycle_Try_ThreadId_Index()
    {
        ...
        // set.
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::set_flag_praisingWrite(bool newFlag)
    {
        _flag_praisingWrite = newFlag;
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::set_Item_On_list_Of_2ibt_flag_WriteState(OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj, uint8_t concurrenctThreadID, std::list<bool> newState)
    {
        auto temp = obj->get_ptr_WriteEnable()->get_ptr_WriteEnable_Control()->get_ptr_list_Of_2ibt_flag_WriteState()->begin();
        std::advance(temp, concurrenctThreadID);
        *temp = newState;
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::set_Item_On_list_Of_WriteActive_Count_For_ThreadId(OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj, uint8_t concurrenctThreadID, uint32_t newCount)
    {
        auto temp = obj->get_ptr_WriteEnable()->get_ptr_WriteEnable_Control()->get_ptr_list_Of_WriteActive_Count_For_ThreadId()->begin();
        std::advance(temp, concurrenctThreadID);
        *temp = newCount;
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::set_Item_On_list_Of_WriteIdle_Count_For_ThreadId(OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj, uint8_t concurrenctThreadID, uint32_t newCount)
    {
        auto temp = obj->get_ptr_WriteEnable()->get_ptr_WriteEnable_Control()->get_ptr_list_Of_WriteIdle_Count_For_ThreadId()->begin();
        std::advance(temp, concurrenctThreadID);
        *temp = newCount;
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::set_Item_On_list_Of_WriteWait_Count_For_ThreadId(OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj, uint8_t concurrenctThreadID, uint32_t newCount)
    {
        auto temp = obj->get_ptr_WriteEnable()->get_ptr_WriteEnable_Control()->get_ptr_list_Of_WriteWait_Count_For_ThreadId()->begin();
        std::advance(temp, concurrenctThreadID);
        *temp = newCount;
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::set_Item_On_QUE_List_Of_ThreadToWrite(OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj, uint8_t slotID, uint8_t concurrenctThreadID)
    {
        auto temp = obj->get_ptr_WriteEnable()->get_ptr_WriteEnable_Control()->get_ptr_QUE_List_Of_ThreadToWrite()->begin();
        std::advance(temp, concurrenctThreadID);
        *temp = concurrenctThreadID;
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::set_new_writeCycle_Try_ThreadId_Index(uint8_t newValue)
    {
        _new_writeCycle_Try_ThreadId_Index = newValue;
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::set_writeCycle_Try_ThreadId_Index(uint8_t newValue)
    {
...
// private.
    ...
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::writeEnable_ShiftQueValues(OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj, uint8_t coreId_A, uint8_t coreId_B)
    {
        ...
        // set.
    // static.
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::create_flag_praisingWrite(bool newDEAFULT_bool)
    {
        Set_flag_praisingWrite(false);
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::create_list_Of_2ibt_flag_WriteState(bool newDEAFULT_bool)
    {
    ...
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::create_new_writeCycle_Try_ThreadId_Index(uint8_t* newDEFAULT_uint32_t)
    {
        Set_new_writeCycle_Try_ThreadId_Index(*newDEFAULT_uint32_t);
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::create_QUE_List_Of_ThreadToWrite(uint8_t* newDEFAULT_uint32_t)
    {
    ...
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::create_writeCycle_Try_ThreadId_Index(uint8_t* newDEFAULT_uint32_t)
    {
        Set_writeCycle_Try_ThreadId_Index(*newDEFAULT_uint32_t);
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::create_ptr_list_Of_WriteActive_Count_For_ThreadId()
    {
        set_ptr_list_Of_WriteActive_Count_For_ThreadId(&_list_Of_WriteActive_Count_For_ThreadId);
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::create_ptr_list_Of_WriteIdle_Count_For_ThreadId()
    {
        set_ptr_list_Of_WriteIdle_Count_For_ThreadId(&_list_Of_WriteIdle_Count_For_ThreadId);
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::create_ptr_list_Of_WriteWait_Count_For_ThreadId()
    {
        set_ptr_list_Of_WriteWait_Count_For_ThreadId(&_list_Of_WriteWait_Count_For_ThreadId);
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::create_ptr_list_Of_2ibt_flag_WriteState()
    {
        set_ptr_list_Of_2ibt_flag_WriteState(&_list_Of_2ibt_flag_WriteState);
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::create_ptr_QUE_List_Of_ThreadToWrite()
    {
    ...
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::set_ptr_list_Of_WriteActive_Count_For_ThreadId(std::list<uint32_t>* newPtr)
    {
        _ptr_list_Of_WriteActive_Count_For_ThreadId = newPtr;
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::set_ptr_list_Of_WriteIdle_Count_For_ThreadId(std::list<uint32_t>* newPtr)
    {
        _ptr_list_Of_WriteIdle_Count_For_ThreadId = newPtr;
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::set_ptr_list_Of_WriteWait_Count_For_ThreadId(std::list<uint32_t>* newPtr)
    {
        _ptr_list_Of_WriteWait_Count_For_ThreadId = newPtr;
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::set_ptr_list_Of_2ibt_flag_WriteState(std::list<std::list<bool>>* newPtr)
    {
        _ptr_list_Of_2ibt_flag_WriteState = newPtr;
    }
    void OpenAvrilCLIDWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control::set_ptr_QUE_List_Of_ThreadToWrite(std::list<uint8_t>* newPtr)
    {
