...
// private.
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::launchEnable_ShiftQueValues(OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Framework* obj, uint8_t concurrentThreadID_A, uint8_t concurrentThreadID_B)
    {
        ...
        // set.
    // static.
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::stat_create_concurrentCycle_Try_CoreId_Index(uint8_t* newDEFAULT_Value)
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::stat_create_flag_praisinglaunch(bool* newDEFAULT_Flagbit)
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::stat_create_list_Of_launchActive_Count_For_ThreadID(uint32_t* newDEFAULT_Value)
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::stat_create_list_Of_launchIdle_Count_For_ThreadID(uint32_t* newDEFAULT_Value)
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::stat_create_list_Of_STATE_For_ConcurrentCore(bool* newDEFAULT_FlagBit)
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::stat_create_list_for_Que_Of_CoreTolaunch()
    {
    ...
    void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtCLIENT::LaunchEnableForConcurrentThreadsAt_CLIENT_Control::stat_create_new_concurrentCycle_Try_CoreId_Index(uint8_t* newDEFAULT_Value)
    {
